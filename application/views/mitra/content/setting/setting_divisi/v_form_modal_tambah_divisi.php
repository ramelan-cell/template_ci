    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <div class="row">
                ...
                <div class="col-md-4">
                    <input class="form-control" name="nama_divisi" id="nama_divisi" onkeyup="javascript:this.value=this.value.toUpperCase()">
                </div>
            </div>
        </div>
        <div class="modal-footer">
            <button type="button" class="btn btn-primary btn-sm" onclick="simpan_divisi()">
...
function simpan_divisi(){
    ...
    $.ajax({
        url: "<?php echo base_url().'setting/setting_divisi/simpan_divisi' ?>",
        type: "POST",
        cache: false,
        data : formData,
        processData: false,
